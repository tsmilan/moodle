...
$string['countunavailable'] = 'Count not available';
...
$string['needsindexing'] = 'need indexing';
$string['next'] = 'Next';
...
$string['overallindexingprogress'] = 'Overall indexing progress';
$string['overallprogressexcluded'] = '{$a} area(s) not included — total count unavailable';
...
$string['searchindexprogress'] = 'Indexing progress';
