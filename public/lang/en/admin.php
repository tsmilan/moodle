...
$string['searchmaxparallelindexing'] = 'Maximum parallel indexing tasks';
$string['searchmaxparallelindexing_desc'] = 'When greater than zero, each search area is indexed by a separate adhoc task, allowing parallel execution. Set to the number of concurrent indexing tasks you want to allow. Set to 0 to use the default sequential indexing.';
