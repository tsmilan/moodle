...
if ($hassiteconfig) { // speedup for non-admins, add all caps used on this page
    ...
    $temp->add(new admin_setting_configtext('debugsessionlock', new lang_string('sessionlockwarning', 'admin'), new lang_string('sessionlockwarning_desc', 'admin'), 0, PARAM_FLOAT));
