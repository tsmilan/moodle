...
$string['debugsessionlock'] = 'Debug session lock';
...
$string['sessionlockwarning'] = 'Display session lock warning';
$string['sessionlockwarning_desc'] = 'Enable if you want to debug session lock timeout';
